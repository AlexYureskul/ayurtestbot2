...
// Обертываем весь код в обработчик события DOMContentLoaded
window.addEventListener('DOMContentLoaded', () => {
  ...
  appId: "1:935248261137:web:4a468ed8d42dc0b724c1b0"
    ...
    // Импорт Three.js и GLTFLoader
    import * as THREE from 'https://cdn.jsdelivr.net/npm/three@0.154.0/build/three.module.js';
    import { GLTFLoader } from 'https://cdn.jsdelivr.net/npm/three@0.154.0/examples/jsm/loaders/GLTFLoader.js';

    // Импорт i18next
    import i18next from 'https://unpkg.com/i18next@21.6.8/dist/esm/i18next.js';
